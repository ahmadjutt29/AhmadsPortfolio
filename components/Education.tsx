...
const education = [
    {
        ...
        period: '2021 – 2025',
        detail: 'CGPA: 3.73 / 4.0',
        focus: 'Focusing on Software Architecture, Cloud Computing, and DevOps methodologies.',
        icon: GraduationCap,
        color: 'text-blue-400',
        bg: 'bg-blue-500/10',
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-500 leading-relaxed max-w-md">
                                            Gained comprehensive expertise in cross-platform development, state management, and high-performance UI implementation.
                                        </p>
                                    </div>
                                </motion.div>
                            ))}
