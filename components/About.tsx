                    ...
                    >
                        <div className="prose prose-lg prose-invert text-gray-300 leading-relaxed font-light mx-auto">
                            <p className="text-xl md:text-2xl text-gray-200 mb-6">
                                I am a results-driven <strong className="text-white font-semibold">DevOps Engineer</strong> and <strong className="text-white font-semibold">Software Developer</strong> based in Lahore, passionate about building robust, scalable infrastructure and high-performance applications.
                            </p>
                            <p className="opacity-80">
                                My expertise bridges the gap between development and operations. I specialize in orchestrating cloud environments on <span className="text-blue-400 font-medium">AWS</span>, automating deployment pipelines for zero-downtime releases, and crafting seamless cross-platform experiences using <span className="text-blue-400 font-medium">Flutter</span>.
                            </p>
                        </div>
                    </motion.div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left md:text-center">
                            ...
                            <div className="flex flex-col items-center gap-2 group">
                                ...
                                <div className="flex flex-col items-center text-sm text-gray-400">
                                    ...
                                    <span className="text-xs text-gray-500">University of Central Punjab</span>
                                </div>
                            ...
                            <div className="flex flex-col items-center gap-2 group">
                                ...
                                <div className="flex flex-col items-center gap-1.5 mt-1">
                                    ...
                                    <span className="text-xs text-gray-400 bg-white/5 px-2 py-0.5 rounded-full">Punjabi</span>
                                </div>
                            </div>
                        </div>
                    </motion.div>
