                    ...
                    <>
                        ...
                        >
                            <div className="relative z-10 w-full max-w-[90rem] mx-auto px-6">
                                ...
                                <div className="text-center md:text-left flex flex-col gap-4">
                                    <h1 className="text-5xl md:text-8xl lg:text-[9rem] font-bold tracking-tighter leading-[0.9] text-white">
                                        AHMAD <br />
                                    ...
                                    {/* Profession - Prominent & Styled */}
                                    <motion.div
                                        initial={{ opacity: 0, y: 20 }}
                                        animate={{ opacity: 1, y: 0 }}
                                        transition={{ delay: 0.5, duration: 0.8 }}
                                        className="flex flex-col md:flex-row items-center md:items-start gap-6 mt-2"
                                    >
                                        <div className="flex items-center gap-4 px-8 py-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl hover:bg-white/10 transition-all duration-300 group">
                                            ...
                                            <div className="flex flex-col md:flex-row md:items-baseline gap-1 md:gap-4">
                                                <span className="text-xl md:text-3xl font-bold text-white tracking-wide group-hover:text-blue-400 transition-colors">
                                                    DEVOPS ENGINEER
                                                </span>
                                                <span className="hidden md:inline text-gray-600 text-2xl font-light">/</span>
                                                <span className="text-lg md:text-2xl font-medium text-gray-300 tracking-wide">
                                                    SOFTWARE DEVELOPER
                                                </span>
                                            </div>
                                        </div>
                        ...
                        >
                            <div className="glass-card p-10 rounded-2xl max-w-2xl border-l-4 border-l-blue-500">
                                ...
                                <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-lg">
                                    Architecting the future with <span className="text-white font-medium">Flutter</span> and robust web technologies.
                                    I craft high-performance applications that stand the test of scale.
                                </p>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="glass-card p-10 rounded-2xl max-w-2xl border-r-4 border-r-purple-500">
                                <h2 className="text-5xl md:text-7xl font-bold text-white leading-[0.9] mb-8 tracking-tight">
                                    <span className="text-stroke">CLOUD</span> <br />
                                    NATIVE
                                </h2>
                                <p className="text-lg md:text-xl text-gray-300 leading-relaxed ml-auto max-w-lg">
                                    Mastering the infrastructure with <span className="text-white font-medium">Docker, K8s, & AWS</span>.
                                    Automating security and stability to ensure zero-downtime deployments.
                                </p>
                            </div>
                        </motion.div>
