                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
                    ...
                    <motion.div variants={itemVariants} className="flex flex-col gap-6">
                        ...
                        <div>
                            <h2 className="text-3xl font-bold text-white tracking-tight">
                                Ahmad Shakeel<span className="text-orange-500">.</span>
                            </h2>
                        ...
                        <div className="flex flex-col gap-4 mt-2">
                            ...
                            >
                                ...
                                <span className="text-sm tracking-wide group-hover:translate-x-1 transition-transform">+92 323 8472027</span>
                            </a>
                            ...
                            >
                                ...
                                <span className="text-sm tracking-wide group-hover:translate-x-1 transition-transform">mr.ahmadshakeel29@gmail.com</span>
                            </a>
                            ...
                            <div className="flex items-center gap-3 text-gray-400 group w-fit">
                                ...
                                <span className="text-sm tracking-wide">Lahore, 54810</span>
                            </div>

                            <a
                                href="https://mr-ahmadshakeel.online/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-3 text-gray-400 hover:text-orange-500 transition-colors duration-300 group w-fit"
                            >
                                <div className="p-2 rounded-full bg-white/5 group-hover:bg-orange-500/10 transition-colors">
                                    <Globe className="w-4 h-4 text-gray-300 group-hover:text-orange-500 transition-colors" />
                                </div>
                                <span className="text-sm tracking-wide group-hover:translate-x-1 transition-transform">mr-ahmadshakeel.online</span>
                    ...
                    <motion.div variants={itemVariants} className="flex flex-col items-start md:items-end gap-8">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a
                                href="https://github.com/mr-ahmadshakeel"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-3 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 hover:border-orange-500/50 hover:scale-110 transition-all duration-300 group"
                                aria-label="GitHub"
                            ...
                            <a
                                ...
                                aria-label="Twitter"
                            >
                                <Twitter className="w-5 h-5 text-gray-300 group-hover:text-orange-500 transition-colors" />
                            </a>
                        </div>
                        ...
                        <div className="text-left md:text-right mt-auto pt-8 md:pt-0">
                            <p className="text-gray-500 text-xs">
                                &copy; 2026 Ahmad Shakeel. All Rights Reserved.
                            </p>
